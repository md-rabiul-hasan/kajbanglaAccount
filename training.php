                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Training+Finger Entry Form</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Training+Finger Entry Info </h5>
        ...
        success: function(response) {
           if(response==1)
           {
                cuteAlert({
                      ...
                      message: "Please Authorize the new Training+Finger Entry",
                      buttonText: "Okay"
                    }).then((e)=>{
           ...
           else
           {
                ...
                else
                {
                      ...
                      type: "error",
                      title: "ERROR",
                      message: "Training+Finger Entry not Registered",
                      buttonText: "Okay"
                    }).then((e)=>{
                           window.location.replace("training");
                        })
