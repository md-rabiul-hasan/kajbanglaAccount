                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Authorize Passport Received </strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Unauthorized Passport Received</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      <?php
                                      $q=mysqli_query($con,"SELECT *,pr.passport_no as passport_no,pr.entry_dt_rec as entry_dt FROM `passport_received` pr left join passenger pa on pr.passport_no=pa.passport_no left join users ur on pr.entry_by_rec=ur.user_id where pr.status='0' and pr.entry_by_rec<>'$user_id' order by received_id DESC");
