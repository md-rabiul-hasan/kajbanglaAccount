...
$sql      = "SELECT * FROM `visa` WHERE visa_id = '$visa_id'";
                        ...
                        <div class="ibox-content">
                            <form method="POST" class="data-store-form">
                                            ...
                                            <!-- <label class="col-sm-2 col-form-label">Office RL No</label> -->
                                             <div class="col-sm-4">
                                                <div class="input-group date has-success">
                                                    ...
                                                    <input type="text" placeholder="Visa Date" value="<?php echo $data['visa_dt']; ?>" class="form-control datepicker" name="visa_dt" id="visa_dt" />
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-4 has-success"><input type="text" placeholder="Visa No" value="<?php echo $data['visa_no']; ?>" class="form-control" name="visa" id="visa" required="" >
                                ...
                                <input type="hidden" name="old_visa_img" id="old_visa_img" value="<?php echo $data['visa_img']; ?>">
                                <input type="hidden" name="visa_id" id="visa_id" value="<?php echo $data['visa_id']; ?>">
    ...
    function submitForm()
{
    ...
    var old_visa_img   = document.getElementById('visa_dt').old_visa_img
...
if(errorCheck==0)
{
        ...
        success    : function(response) {
           ...
           if(response==1)
           {
                cuteAlert({
                      type      : "success",
                      title     : "Visa Information Update. ",
                      message   : "Please Authorize the updated Visa Entry",
                      buttonText: "Okay"
                    }).then((e)=>{
           ...
           else
           {
                if(response==5)
                {
                        cuteAlert({
                          type      : "error",
                          title     : "ERROR",
                          message   : "Police Clearance Not Completed Yet",
                          buttonText: "Okay"
                        }).then((e)=>{
                               window.location.replace("VisaList");
                            })
                ...
                else
                {
                      ...
                      type      : "error",
                      title     : "ERROR",
                      message   : "Visa Information Update Failed",
                      buttonText: "Okay"
                    }).then((e)=>{
                           window.location.replace("VisaList");
                        })
