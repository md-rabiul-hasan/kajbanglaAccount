                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form method="get">
                                  <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 has-success"><input type="text" placeholder="Medical Center" class="form-control" name="medical_center" id="medical_center" required="" readonly="">
                                            ...
                                            <div class="input-group date has-success">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Medical Date" class="form-control datepicker" name="medical_dt" id="medical_dt" readonly="" />
                                ...
                                <input type="hidden" name="previousMedStatus" id="previousMedStatus">
...
<script type="text/javascript">
 ...
 function showRemarks(med_id)
 {
    ...
    function getMedicalInfo(passport)
    {
        ...
        success: function(response) {
            ...
            {
              obj = JSON.parse(response);
              document.getElementById('medical_center').value=obj.medical_center;
              document.getElementById('medical_dt').value=obj.medical_dt;
              document.getElementById('previousMedStatus').value=obj.medical_status;
              
            }
            else
            {
                document.getElementById('medical_center').value='';
              document.getElementById('medical_dt').value='';
              document.getElementById('previousMedStatus').value='';  
            }
        ...
        success: function(response) {
           if(response==1)
           {
                cuteAlert({
                      ...
                      message: "Please Authorize the  Medical Update",
                      buttonText: "Okay"
                    }).then((e)=>{
                         window.location.replace("medicalEdit");
                        })
           }
           else if(response==5)
           {
                cuteAlert({
                  type: "error",
                  title: "ERROR",
                  message: "Medical Status Can not be same as previous",
                  buttonText: "Okay"
                }).then((e)=>{
                       window.location.replace("medicalEdit");
                    })
            ...
            else
           {
                cuteAlert({
                  type: "error",
                  title: "ERROR",
                  message: "Medical Update not Registered",
                  buttonText: "Okay"
                }).then((e)=>{
                       window.location.replace("medicalEdit");
                    })
