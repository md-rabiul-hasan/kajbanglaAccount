        ...
        <div id="page-wrapper" class="gray-bg">
          <?php include('navbar.php');?>
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Training+Finger Edit</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="index.html">Home</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a>Training+Finger Edit</a>
                        </li>
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form method="get">
                                  ...
                                  <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <input type="text" placeholder="Passport No" class="form-control"  value="<?php echo $data['passport_no']; ?>" name="passport" id="passport" required="" onkeyup="getPassangerInfo(this.value)">
                                        ...
                                        <br>
                                         <div class="row">
                                            ...
                                            <div class="col-sm-10 row">
                                                ...
                                                <div class="i-checks"><label> <input type="radio" value="1" <?php if($data['training_ceftificate'] == 'YES'){ echo "checked"; } ?> name="training_cerfiticate"> <i></i>Yes</label></div>
                                                <div class="i-checks"><label> <input type="radio" <?php if($data['training_ceftificate'] == 'NO'){ echo "checked"; } ?>value="0" name="training_cerfiticate"> <i></i>No</label></div>
                                            ...
                                            <div class="col-sm-10 row">
                                                Finger:&nbsp;
                                                <div class="i-checks"><label> <input type="radio"  <?php if($data['fingering'] == 'YES'){ echo "checked"; } ?> value="1" name="finger"> <i></i>Yes</label></div>
                                                <div class="i-checks"><label> <input type="radio" <?php if($data['fingering'] == 'NO'){ echo "checked"; } ?> value="0" name="finger"> <i></i>No</label></div>
                                ...
                                <input type="hidden" name="training_id" id="training_id" value="<?php echo $data['training_id']; ?>">
...
if(errorCheck==0)
{
        ...
        success: function(response) {
           if(response==1)
           {
                cuteAlert({
                      type: "success",
                      title: "Training + Finger Update",
                      message: "Please Authorize the updated Training+Finger",
                      buttonText: "Okay"
                    }).then((e)=>{
                         window.location.replace("trainingList");
                        })
           }
           else
           {
                ...
                else
                {
                      ...
                      type: "error",
                      title: "ERROR",
                      message: "Training + Finger Update Failed",
                      buttonText: "Okay"
                    }).then((e)=>{
                           window.location.replace("trainingList");
                        })
