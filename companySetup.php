                            ...
                            <form method="get">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 has-success"><input type="number" placeholder="Purchase Amount (BDT)" class="form-control" name="purchase_amt" id="purchase_amt" required="">
                                            ...
                                            <div class="col-md-4 has-success"><input type="number" placeholder="Selling Amount (BDT)" class="form-control" name="sales_amt" id="sales_amt" required="">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                                ...
                                                <select class="select2_demo_1 form-control " required="" id="office_id" onchange="showSubGl(this.value)">
                                                    <option value="">--Select Office--</option>
                                                        ...
                                                        ?>
                                                              ...
                                                              <option value="<?php print $office_id;?>"><?php print $office_name;?></option>
                                             ...
                                             <div class="col-md-4 has-success"><input type="text" placeholder="Salary" class="form-control" name="salary" id="salary" required="">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <!-- <label class="col-sm-2 col-form-label">Office Phone No</label> -->
                                            <div class="col-md-4 has-success"><input type="text" placeholder="Working Hour" class="form-control" name="working_hr" id="working_hr" required="">
                                                
                                            </div>
                                            <!-- <label class="col-sm-2 col-form-label">Office Email</label> -->
                                            <div class="col-md-4 has-success"><input type="text" placeholder="Food" class="form-control" name="food" id="food" required="">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <!-- <label class="col-sm-2 col-form-label">Office Phone No</label> -->
                                            <div class="col-md-4 has-success"><input type="text" placeholder="Accommodation" class="form-control" name="accommodation" id="accommodation" required="">
                                                
                                            </div>
                                            <!-- <label class="col-sm-2 col-form-label">Office Email</label> -->
                                            <div class="col-md-4 has-success"><input type="text" placeholder="Age Limit" class="form-control" name="age_limit" id="age_limit" required="">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <!-- <label class="col-sm-2 col-form-label">Office Phone No</label> -->
                                            <div class="col-md-4 has-success"><input type="text" placeholder="Reference Code" class="form-control" name="ref_code" id="ref_code" required="">
...
if(errorCheck==0)
{
        ...
        success: function(response) {
           ...
           if(response==1)
           {
                cuteAlert({
                      type: "success",
                      title: "New Company Info Registered. ",
                      message: "Please Authorize the new Company Info",
                      buttonText: "Okay"
                    }).then((e)=>{
           ...
           else
           {
                cuteAlert({
                  type: "error",
                  title: "ERROR",
                  message: "New Company Info not Registered",
                  buttonText: "Okay"
                }).then((e)=>{
                       window.location.replace("companySetup");
                    })
