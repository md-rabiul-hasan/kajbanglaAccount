...
$sql      = "SELECT * FROM `agent_info` WHERE agent_id = '$agent_id'";
                            ...
                            <div class="ibox-content">
                                <form method="POST" class="data-store-form">
                                    <div class="form-group row has-success">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="agent_name" value="<?php echo $data['agent_name']; ?>" placeholder="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row has-success">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="agent_ref_code" value="<?php echo $data['referral_code']; ?>" placeholder="" />
                                        </div>
                                    ...
                                    <div class="form-group row has-success">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="phone_no" value="<?php echo $data['agent_mobile']; ?>" placeholder="" />
                                        </div>
                                        <label class="col-sm-2 col-form-label"><b>email</b></label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="email" value="<?php echo $data['agent_email']; ?>" placeholder="" />
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group row has-success">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="address" value="<?php echo $data['agent_address']; ?>" placeholder="" />
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group row has-success">
                                    ...
                                    <input type="hidden" name="old_agent_img" id="old_agent_img" value="<?php echo $data['agent_img']; ?>">
                                    <input type="hidden" name="old_agent_nid_img" id="old_agent_nid_img" value="<?php echo $data['agent_nid_img']; ?>">
                                    <input type="hidden" name="agent_id" id="agent_id" value="<?php echo $data['agent_id']; ?>">

                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="button" class="btn btn-primary btn-bg" id="registerBtn" value="Update Agent" name="register" />
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $('#registerBtn').click(function(e) {
                        ...
                        var old_agent_img     = $(this).closest('form').find('input[name=old_agent_img]').val();
                        var old_agent_nid_img = $(this).closest('form').find('input[name=old_agent_nid_img]').val();
                        var agent_id          = $(this).closest('form').find('input[name=agent_id]').val();
                            ...
                            success: function(response) {
                                ...
                                if (response == 1) {
                                    ...
                                    cuteAlert({
                                          type      : "success",
                                          title     : "Agent Update. ",
                                          message   : "Please Authorize the updated Agent",
                                          buttonText: "Okay"
                                        }).then((e)=>{
