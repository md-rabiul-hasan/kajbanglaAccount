                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Profession Setup Form</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                            ...
                            <div class="ibox-content">
                                <form method="POST" class="data-store-form">
                                    <div class="form-group row has-success">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="profession_name" placeholder="" />
                                        </div>
                                    </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response == 1) {
                                    ...
                                    cuteAlert({
                                          type: "success",
                                          title: "New Profession Registered. ",
                                          message: "Please Authorize the new Profession",
                                          buttonText: "Okay"
                                        }).then((e)=>{
                                             window.location.replace("profession");
                                            })
                                } else {
                                    cuteAlert({
                                          type: "error",
                                          title: "ERROR",
                                          message: "Profession not Registered",
                                          buttonText: "Okay"
                                        }).then((e)=>{
                                               window.location.replace("profession");
                                            })
