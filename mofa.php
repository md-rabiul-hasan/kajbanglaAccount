                                  ...
                                  <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 has-success"><input type="text" placeholder="Mofa Remakrs" class="form-control" name="mofa_remarks" id="mofa_remarks" required="" >
                                            ...
                                            <div class="input-group date has-success">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Mofa Date" class="form-control datepicker" name="mofa_dt" id="mofa_dt" />
        ...
        success: function(response) {
           if(response==1)
           {
                cuteAlert({
                      ...
                      message: "Please Authorize the new MOFA Entry",
                      buttonText: "Okay"
                    }).then((e)=>{
           ...
           else
           {
                cuteAlert({
                  type: "error",
                  title: "ERROR",
                  message: "MOFA Entry not Registered",
                  buttonText: "Okay"
                }).then((e)=>{
                       window.location.replace("mofa");
                    })
