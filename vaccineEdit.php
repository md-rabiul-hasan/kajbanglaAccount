                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Man Power Entry Form</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form method="POST" class="data-store-form">
                                            ...
                                            <!-- <label class="col-sm-2 col-form-label">Office RL No</label> -->
                                             <div class="col-sm-4">
                                                <div class="input-group date has-success">
                                                    ...
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Vaccine 1st Dose Date" class="form-control datepicker" name="vac_1_dt" id="vac_1_dt" readonly="" />
                                             ...
                                             <div class="col-sm-4">
                                                <div class="input-group date has-success">
                                                    ...
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Vaccine 2nd Dose Date" class="form-control datepicker" name="vac_2_dt" id="vac_2_dt" />
                                 ...
                                 <div class="form-group row">
                                    <div class="col-md-4 has-success"><input type="text" placeholder="Vaccine Remarks" class="form-control" name="vac_remarks" id="vac_remarks" required="" >
 ...
 function getVacInfo(passport)
    {
        ...
        success: function(response) {
            ...
            if(response!='')
            {
              ...
              document.getElementById('vac_1_dt').value=obj.vaccine_1_dt;
              
              
            }
            else
            {
                document.getElementById('vac_1_dt').value='';
...
if(errorCheck==0)
{
        ...
        success: function(response) {
           ...
           if(response==1)
           {
                cuteAlert({
                      type: "success",
                      title: "New Vaccine Update Entry Registered. ",
                      message: "Please Authorize the new Vaccine Update Entry",
                      buttonText: "Okay"
                    }).then((e)=>{
                         window.location.replace("vaccineEdit");
                        })
           }
           else
           {
                ...
                else
                {
                      ...
                      type: "error",
                      title: "ERROR",
                      message: "Vaccine Update not Registered",
                      buttonText: "Okay"
                    }).then((e)=>{
                           window.location.replace("vaccineEdit");
                        })
