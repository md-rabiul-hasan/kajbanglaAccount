                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Training+Finger List</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      <?php
                                      $q=mysqli_query($con,"SELECT *,pr.passport_no as passport_no,pr.entry_dt_t_f as entry_dt FROM `training` pr  
                                      left join passenger pa on pr.passport_no=pa.passport_no 
                                      left join users ur on pr.entry_by_t_f=ur.user_id 
                                      where pr.status='1' order by training_id DESC");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editTraining?training_id=<?php print $process_id; ?>">
                                                <i class="fa fa-edit text-navy">Edit</i>
                                            </a> 
                                            <br>
                                            <a href="#" onclick="deleteTraining('<?php print $process_id; ?>')">
...
<script>
    function deleteTraining(training_id ){
        if(confirm("Are you sure? You want to delete this traning+finger information?")){
            $.ajax({  
            type: 'POST',  
            url: 'deleteTraining', 
            data: {
