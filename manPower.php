                                            ...
                                            <!-- <label class="col-sm-2 col-form-label">Office RL No</label> -->
                                             <div class="col-sm-4">
                                                <div class="input-group date has-success">
                                                    ...
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Man Power Date" class="form-control datepicker" name="mp_dt" id="mp_dt" />
...
if(errorCheck==0)
{
        ...
        success: function(response) {
           ...
           if(response==1)
           {
                cuteAlert({
                      type: "success",
                      title: "New Man Power Entry Registered. ",
                      message: "Please Authorize the new Man Power Entry",
                      buttonText: "Okay"
                    }).then((e)=>{
                         window.location.replace("manPower");
                        })
           }
           else
           {
                ...
                else
                {
                      ...
                      type: "error",
                      title: "ERROR",
                      message: "Man Power Entry not Registered",
                      buttonText: "Okay"
                    }).then((e)=>{
                           window.location.replace("manPower");
                        })
