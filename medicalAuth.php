                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      <?php
                                      $q=mysqli_query($con,"SELECT *,pr.passport_no as passport_no,pr.entry_dt_medical as entry_dt FROM `medical` pr left join medical_status ms on pr.medical_status=ms.medical_status_id left join passenger pa on pr.passport_no=pa.passport_no left join users ur on pr.entry_by_medical=ur.user_id left join medical_country cnt on cnt.country_id=pr.medical_country where pr.status='0' and pr.entry_by_medical<>'$user_id' order by medical_id DESC");
