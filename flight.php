                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Flight Entry Form</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form method="POST" class="data-store-form">
                                            ...
                                            <!-- <label class="col-sm-2 col-form-label">Office RL No</label> -->
                                             <div class="col-sm-4">
                                                <div class="input-group date has-success">
                                                    ...
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Flight Date" class="form-control datepicker" name="flight_dt" id="flight_dt" />
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4 has-success"><input type="text" placeholder="Flight No" class="form-control" name="flight_no" id="flight_no" required="" >
                                            <div style="color: red;display: none" id="flight_no_Div">*Flight No Can not be empty</div>
                                           
                                           
                                        </div>
                                  <div class="col-md-4 has-success"><input type="text" placeholder="Airline Name" class="form-control" name="airline" id="airline" required="" >
...
if(errorCheck==0)
{
        ...
        success: function(response) {
           ...
           if(response==1)
           {
                cuteAlert({
                      type: "success",
                      title: "New Flight Entry Registered. ",
                      message: "Please Authorize the new Flight Entry",
                      buttonText: "Okay"
                    }).then((e)=>{
                         window.location.replace("flight");
                        })
           }
           else
           {
                ...
                else
                {
                      ...
                      type: "error",
                      title: "ERROR",
                      message: "Flight Entry not Registered",
                      buttonText: "Okay"
                    }).then((e)=>{
                           window.location.replace("flight");
                        })
