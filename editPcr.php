...
$pcr_id = $_GET['pcr_id'];
$sql      = "SELECT * FROM `pcr` WHERE pcr_id = '$pcr_id'";
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form method="get">
                                  ...
                                  <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                         ...
                                         <div class="col-md-4 has-success">
                                             <input type="text" placeholder="Next PCR Date" value="<?php echo $data['next_pcr_dt']; ?>" class="form-control datepicker" name="pcr_dt" id="pcr_dt" required="" >
                                        ...
                                        <br>
                                         <div class="row">
                                            ...
                                            <div class="col-sm-10 row">
                                                COVID-19:&nbsp;
                                                <div class="i-checks"><label> <input type="radio" value="P" <?php if($data['pcr_test'] == 'P'){ echo "checked"; } ?> name="pcr" > <i></i>POSITIVE</label></div>
                                                <div class="i-checks"><label> <input type="radio" <?php if($data['pcr_test'] == 'N'){ echo "checked"; } ?> value="N" name="pcr" > <i></i>NEGATIVE</label></div>
                                ...
                                <input type="hidden" name="pcr_id" id="pcr_id" value="<?php echo $data['pcr_id']; ?>">
                        ...
                        <div id="dumpdata"></div>
                        <div class="col-md-66" id="showPassengerInfo" style="display: none;">
                        <br>
    ...
    function submitForm()
{
    ...
    var pcr_id         = document.getElementById('pcr_id').value
...
if(errorCheck==0)
{
        ...
        success: function(response) {
           if(response==1)
           {
                cuteAlert({
                      type: "success",
                      title: "Pcr Test Update",
                      message: "Please Authorize the updated PCR",
                      buttonText: "Okay"
                    }).then((e)=>{
                         window.location.replace("pcrList");
                        })
           }
           else
           {
                ...
                else
                {
                      ...
                      type: "error",
                      title: "ERROR",
                      message: "Pcr Test Update Failed",
                      buttonText: "Okay"
                    }).then((e)=>{
                           window.location.replace("pcrList");
                        })
