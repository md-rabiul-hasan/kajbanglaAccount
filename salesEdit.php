                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form method="get">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                             <div class="col-md-4 has-success">
                                                <select class="select2_demo_1 form-control " required="" id="company" >
                                                ...
                                                <div class="col-md-4 has-success">
                                                <select class="select2_demo_1 form-control " required="" id="profession_id" name="profession_id">
                                                    <option value="">--Select Company--</option>
                                                        <?php 
                                                        $qGlType=mysqli_query($con,"SELECT * FROM `profession`");
                                                        while($dGlType=mysqli_fetch_array($qGlType))
                                                        {
                                  ...
                                  <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 has-success">
                                                <input type="text" placeholder="Passport No" class="form-control" name="passport"  value="<?php echo $data['passport_no']; ?>" id="passport" required="" onkeyup="getPassangerInfo(this.value)">
                                            ...
                                            <div class="col-md-4 has-success"><input type="text" placeholder="Purchase Amount(BDT)"  value="<?php echo $data['purchase_amt']; ?>" class="form-control" name="purchase_amt" id="purchase_amt" readonly="" >
                                                 <div style="color: red;display: none" id="purchase_amt_Div">*Purchase Amount(BDT) Can not be empty</div>
                                                  
                                            </div>
                                            <div class="col-md-4 has-success"><input type="text" placeholder="Sale Amount(BDT)"  value="<?php echo $data['sale_amt']; ?>" class="form-control" name="sale_amt" id="sale_amt" required="" >
                                ...
                                <input type="hidden" name="sale_id" id="sale_id" value="<?php echo $data['sale_id']; ?>" />
        ...
        success: function(response) {
           if(response==1)
           {
                cuteAlert({
                      type: "success",
                      title: "Sales Updated ",
                      message: "Please Authorize the updated Sale",
                      buttonText: "Okay"
                    }).then((e)=>{
