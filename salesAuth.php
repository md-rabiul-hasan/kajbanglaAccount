                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      <?php
                                      $q=mysqli_query($con,"select *,s.passport_no as passport_no,s.sale_amt as sale_amt,s.purchase_amt as purchase_amt from sales s left join company cmp on cmp.company_id=s.company_id left join company_info cmpi on s.company_id=cmpi.company_id left join passenger p on s.passport_no=p.passport_no left join users u on u.user_id=s.entry_by_sale left join profession prf on s.profession=prf.profession_id where s.status='0' and s.entry_by_sale<>'$user_id' and s.company_id=cmpi.company_id and s.profession=cmpi.profession");
