                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      <?php
                                      $q=mysqli_query($con,"SELECT *,pr.passport_no as passport_no,pr.entry_dt_visa as entry_dt FROM `visa` pr left join passenger pa on pr.passport_no=pa.passport_no left join users ur on pr.entry_by_visa=ur.user_id  where pr.status='0' and pr.entry_by_visa<>'$user_id' order by visa_id DESC");
