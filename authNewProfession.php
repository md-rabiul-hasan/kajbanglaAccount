                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      <?php
                                      $q=mysqli_query($con,"SELECT *,ai.entry_dt as entry_dt FROM `profession` ai  left join users usr on ai.entry_by=usr.user_id where ai.status='0' and ai.entry_by<>'$user_id' order by ai.profession_id DESC");
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" onclick="authProfession('<?php print $profession_id; ?>','1')"><i class="fa fa-check text-navy">Accept</i></a> <br><a href="#" onclick="authProfession('<?php print $profession_id; ?>','0')"><i class="fa fa-close " style="color:red">Decline</i></a></td>
                                    </tr>
                                     <?php
                                      }
                                      ?>
