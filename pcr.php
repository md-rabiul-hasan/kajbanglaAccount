                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>PCR TEST  Entry Form</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                                  ...
                                  <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                         ...
                                         <div class="col-md-4 has-success"><input type="text" placeholder="Next PCR Date" class="form-control datepicker" name="pcr_dt" id="pcr_dt" required="" >
                                        ...
                                        <br>
                                         <div class="row">
                                            ...
                                            <div class="col-sm-10 row">
                                                COVID-19:&nbsp;
                                                <div class="i-checks"><label> <input type="radio" value="P" name="pcr" > <i></i>POSITIVE</label></div>
                                                <div class="i-checks"><label> <input type="radio" checked="" value="N" name="pcr" > <i></i>NEGATIVE</label></div>
