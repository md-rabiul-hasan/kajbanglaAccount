...
if(isset($_POST['office_name']) and isset($_POST['office_rl_no']) and isset($_POST['office_email']) and isset($_POST['office_address']) and isset($_POST['office_phone_no']))
{
	...
	{
		$qInsert=mysqli_query($con,"INSERT INTO `office`( `office_name`, `office_rl_no`, `office_phone_no`, `office_email`, `office_address`, `status`, `entry_by`, `entry_dt`) VALUES ('$office_name','$office_rl_no','$office_phone_no','$office_email','$office_address','1','user_id','$entry_dt')");
		if($qInsert)
		{
			$response=1;//success
		}
