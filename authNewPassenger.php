                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      ...
                                      left join users usr on pas.entry_by=usr.user_id
                                       where pas.status='0' and pas.entry_by<>'$user_id' order by pas.passenger_id DESC");
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" onclick="authOffice('<?php print $passenger_id; ?>','1')"><i class="fa fa-check text-navy">Accept</i></a> <br><a href="#" onclick="authOffice('<?php print $passenger_id; ?>','0')"><i class="fa fa-close " style="color:red">Decline</i></a></td>
                                    </tr>
                                     <?php
                                      }
                                      ?>
