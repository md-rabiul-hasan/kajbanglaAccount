                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      <?php
                                      $q=mysqli_query($con,"SELECT *,cmpi.entry_dt as entry_dt FROM `company_info` cmpi 
                                      left join company cmp on cmpi.company_id=cmp.company_id 
                                      left join office ofc on ofc.office_id=cmpi.office_id 
                                      left join users usr on usr.user_id=cmpi.entry_by 
                                      left join profession prf on prf.profession_id=cmpi.profession 
                                      left join medical_country cnt on cnt.country_id=cmpi.country 
                                      where cmpi.status='1'");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editCompanyInformation?company_info_id=<?php print $company_info_id; ?>">
               ...
               if(response==1)
                 {
                      cuteAlert({
                            ...
                            buttonText: "Okay"
                               ...
                               window.location.replace("editNewCompany");
                              })
                 }
                 else if(response==2)
                 {
...
<script>
    function delteCompany(company_info_id ){
