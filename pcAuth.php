                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Authorize Police Clearance </strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Unauthorized Police Clearance</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      <?php
                                      $q=mysqli_query($con,"SELECT *,pr.passport_no as passport_no,pr.entry_dt_pc as entry_dt FROM `pc` pr left join passenger pa on pr.passport_no=pa.passport_no left join users ur on pr.entry_by_pc=ur.user_id where pr.status='0' and pr.entry_by_pc<>'$user_id' order by pc_id DESC");
