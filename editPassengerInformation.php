...
<?php 
    ...
    $sql          = "SELECT * FROM `passenger` WHERE passenger_id ='$passenger_id'";
                            ...
                            <div class="ibox-content">
                                <form method="POST" class="data-store-form">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="passenger_name" value="<?php echo $data['passenger_name']; ?>" placeholder="" />
                                        </div>
                                        <label class="col-sm-2 col-form-label"><b>Passport NO.</b></label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="passport_no" value="<?php echo $data['passport_no']; ?>" placeholder="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control datepicker" value="<?php echo $data['passport_issue_dt']; ?>" name="passport_issue_dt" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                <input type="text" class="form-control datepicker"  value="<?php echo $data['passport_expire_dt']; ?>" name="passport_expire_dt" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="father_name" value="<?php echo $data['father_name']; ?>"  placeholder="" />
                                        </div>
                                        <label class="col-sm-2 col-form-label"><b>Mother Name</b></label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="mother_name" value="<?php echo $data['mother_name']; ?>" placeholder="" />
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                <input type="text" class="form-control datepicker" value="<?php echo $data['date_of_birth']; ?>" name="date_of_birth" />
                                            </div>
                                        </div>
                                        <label class="col-sm-2 col-form-label"><b>Place Of Birth</b></label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="place_of_birth" value="<?php echo $data['place_of_birth']; ?>" placeholder="" />
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="phone_no" value="<?php echo $data['phone_no']; ?>" placeholder="" />
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="present_address" value="<?php echo $data['present_address']; ?>" placeholder="" />
                                        </div>
                                        <label class="col-sm-2 col-form-label"><b>Parmanent Address</b></label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="parmanent_address" value="<?php echo $data['parmanent_address']; ?>" placeholder="" />
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control m-b select2" name="reference_agent_id">
                                                ...
                                                <?php while ($role_data = mysqli_fetch_array($roles_qry)) { ?>
                                                    <option value="<?php echo $role_data['agent_id']; ?>" <?php if($role_data['agent_id'] == $data['reference_agent_id']){ echo "selected"; } ?> ><?php echo $role_data['agent_name']."(".$role_data['agent_mobile'].")"; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" name="old_passenger_img" value="<?php echo $data['passenger_img']; ?>">
                                    <input type="hidden" name="old_passport_img" value="<?php echo $data['passport_img']; ?>">
                                    <input type="hidden" name="passenger_id" value="<?php echo $passenger_id; ?>">


                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="button" class="btn btn-primary btn-bg" id="registerBtn" value="Update" name="update" />
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $('#registerBtn').click(function(e) {
                        ...
                        var old_passenger_img  = $(this).closest('form').find('input[name=old_passenger_img]').val();
                        var old_passport_img   = $(this).closest('form').find('input[name=old_passport_img]').val();
                        var passenger_id       = $(this).closest('form').find('input[name=passenger_id]').val();
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response == 1) {
                                    cuteAlert({
                                        type      : "success",
                                        title     : "Passanger Edit Successfully. ",
                                        message   : "Please Authorize the Passanger",
                                        buttonText: "Okay"
                                    }).then((e)=>{
