                                            ...
                                            <!-- <label class="col-sm-2 col-form-label">Office RL No</label> -->
                                             <div class="col-sm-4">
                                                <div class="input-group date has-success">
                                                    ...
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Vaccine 1st Dose Date" class="form-control datepicker" name="vac_1_dt" id="vac_1_dt" />
...
if(errorCheck==0)
{
        ...
        success: function(response) {
           ...
           if(response==1)
           {
                cuteAlert({
                      type: "success",
                      title: "New Vaccine Entry Registered. ",
                      message: "Please Authorize the new Vaccine Entry",
                      buttonText: "Okay"
                    }).then((e)=>{
           ...
           else
           {
                ...
                else
                {
                      ...
                      type: "error",
                      title: "ERROR",
                      message: "Vaccine Entry not Registered",
                      buttonText: "Okay"
                    }).then((e)=>{
                           window.location.replace("vaccine");
                        })
